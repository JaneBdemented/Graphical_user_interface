...
<body>
          ...
          <div class="col-lg-12">
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <i class="fa fa-user"></i> <b>Devices</b>
    ...
    <p>You can now change the settings of the users.</p>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
											...
											<?php
													$get_devices = DB::getInstance()->query("SELECT * FROM devices");
    foreach($get_devices->results() as $get_devices){
	echo'<tr>';
	echo '<td>'.$get_devices->device_name.'</td>';
	echo '<td>'.$get_devices->MAC_address.'</td>';
	echo '<td>'.$get_devices->Block.'</td>';
	echo '<td>'.$get_devices->user_total.'</td>';
    echo '<td>'.$get_devices->total_all.'</td>';
	echo '<td>'.$get_devices->time_start.'</td>';
	echo '<td>'.$get_devices->time_end.'</td>';
		echo'</tr>';
	}
	?>
                        ...
                        <!-- /.panel-body -->
						      ...
						      <!-- THIS IS WHERE YOU CAN UPDATE THE BUTTONS-->
						...
						<div class="form-group">
											...
											<?php
													$get_users = DB::getInstance()->query("SELECT * FROM users");
    foreach($get_users->results() as $get_users){
	echo '<option>'.$get_users->username.'</option>';
	}
	?>
